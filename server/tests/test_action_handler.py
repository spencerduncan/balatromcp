...
class TestBalatroActionHandlerInitialization:
    ...
    def test_action_validators_coverage(self, action_handler):
        ...
        expected_validators = {
            "play_hand", "discard_cards", "go_to_shop", "buy_item",
            "sell_joker", "sell_consumable", "reorder_jokers", "select_blind",
            "select_pack_offer", "reroll_boss", "reroll_shop", "sort_hand_by_rank",
            "sort_hand_by_suit", "use_consumable"
        }
...
class TestExecuteAction:
    ...
    @pytest.mark.asyncio
    async def test_execute_action_success(self, action_handler, mock_file_io, mock_state_manager, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_execute_action_no_game_state(self, action_handler, mock_state_manager):
    ...
    @pytest.mark.asyncio
    async def test_execute_action_invalid_action(self, action_handler, mock_state_manager, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_execute_action_write_failure(self, action_handler, mock_file_io, mock_state_manager, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_execute_action_timeout(self, action_handler, mock_file_io, mock_state_manager, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_execute_action_exception_handling(self, action_handler, mock_state_manager):
...
class TestValidateAction:
    ...
    @pytest.mark.asyncio
    async def test_validate_action_not_available(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_action_available_no_validator(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_action_with_specific_validator(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_action_exception_handling(self, action_handler, hand_selection_state):
...
class TestPlayHandValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_play_hand_no_hands_remaining(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_play_hand_invalid_indices(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_play_hand_empty_selection(self, action_handler, hand_selection_state):
...
class TestDiscardCardsValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_discard_cards_valid(self, action_handler, hand_selection_state):
        """Test valid discard cards action."""
        action = DiscardCardsAction(card_indices=[0, 1])
        
        result = await action_handler._validate_discard_cards(action, hand_selection_state)
    ...
    @pytest.mark.asyncio
    async def test_validate_discard_cards_no_discards_remaining(self, action_handler, hand_selection_state):
...
class TestGoToShopValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_go_to_shop_valid(self, action_handler, hand_selection_state):
...
class TestBuyItemValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_buy_item_wrong_phase(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_buy_item_insufficient_money(self, action_handler, shop_state):
...
class TestSellJokerValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_sell_joker_wrong_phase(self, action_handler, hand_selection_state):
...
class TestReorderJokersValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_reorder_jokers_valid(self, action_handler, reorder_available_state):
        """Test valid reorder jokers action."""
        action = ReorderJokersAction(new_order=[2, 0, 1])
        
        result = await action_handler._validate_reorder_jokers(action, reorder_available_state)
        
        assert result is True

    @pytest.mark.asyncio
    async def test_validate_reorder_jokers_not_available(self, action_handler, hand_selection_state):
        """Test reorder jokers validation when not available."""
        action = ReorderJokersAction(new_order=[0])
        
        result = await action_handler._validate_reorder_jokers(action, hand_selection_state)
        
        assert result is False

    @pytest.mark.asyncio
    async def test_validate_reorder_jokers_wrong_count(self, action_handler, reorder_available_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_reorder_jokers_invalid_indices(self, action_handler, reorder_available_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_reorder_jokers_duplicate_indices(self, action_handler, reorder_available_state):
...
class TestBlindSelectionValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_select_blind_valid(self, action_handler, blind_selection_state):
        """Test valid select blind action."""
        action = SelectBlindAction(blind_type="small")
        
        result = await action_handler._validate_select_blind(action, blind_selection_state)
        
        assert result is True

    @pytest.mark.asyncio
    async def test_validate_select_blind_wrong_phase(self, action_handler, hand_selection_state):
        """Test select blind validation in wrong phase."""
        action = SelectBlindAction(blind_type="small")
        
        result = await action_handler._validate_select_blind(action, hand_selection_state)
...
class TestRerollValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_reroll_boss_valid(self, action_handler, blind_selection_state):
        """Test valid reroll boss action."""
        action = RerollBossAction()
        
        result = await action_handler._validate_reroll_boss(action, blind_selection_state)
    ...
    @pytest.mark.asyncio
    async def test_validate_reroll_shop_wrong_phase(self, action_handler, hand_selection_state):
        """Test reroll shop validation in wrong phase."""
        action = RerollShopAction()
        
        result = await action_handler._validate_reroll_shop(action, hand_selection_state)
...
class TestSortHandValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_sort_hand_by_rank_valid(self, action_handler, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_validate_sort_hand_by_suit_valid(self, action_handler, hand_selection_state):
...
class TestUseConsumableValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_use_consumable_valid(self, action_handler, hand_selection_state):
        """Test valid use consumable action."""
        action = UseConsumableAction(item_id="cons1")
        
        result = await action_handler._validate_use_consumable(action, hand_selection_state)
        
        assert result is True

    @pytest.mark.asyncio
    async def test_validate_use_consumable_invalid_id(self, action_handler, hand_selection_state):
...
class TestActionResultProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_result_success_with_new_state(self, processor, mock_state_manager, hand_selection_state):
    ...
    @pytest.mark.asyncio
    async def test_process_result_success_no_new_state(self, processor, mock_state_manager):
