...
class TestGetCurrentState:
    ...
    @pytest.mark.asyncio
    async def test_get_current_state_first_time(self, state_manager, mock_file_io, sample_game_state):
    ...
    @pytest.mark.asyncio
    async def test_get_current_state_cached_when_no_update(self, state_manager, mock_file_io, sample_game_state):
    ...
    @pytest.mark.asyncio
    async def test_get_current_state_updates_from_file(self, state_manager, mock_file_io, sample_game_state, different_game_state):
...
class TestUpdateState:
    ...
    @pytest.mark.asyncio
    async def test_update_state_different_state(self, state_manager, sample_game_state, different_game_state):
    ...
    @pytest.mark.asyncio
    async def test_update_state_tracks_update_time(self, state_manager, sample_game_state):
...
class TestIsStateChanged:
    ...
    @pytest.mark.asyncio
    async def test_is_state_changed_with_change(self, state_manager, mock_file_io, sample_game_state):
...
class TestStatesEqual:
    ...
    def test_states_equal_different_hands_remaining(self, state_manager, sample_game_state):
    ...
    def test_states_equal_different_reorder_availability(self, state_manager, sample_game_state):
...
class TestWaitForStateChange:
    ...
    @pytest.mark.asyncio
    async def test_wait_for_state_change_immediate(self, state_manager, mock_file_io, sample_game_state):
    ...
    @pytest.mark.asyncio
    async def test_wait_for_state_change_delayed(self, state_manager, mock_file_io, sample_game_state):
...
class TestGetStateSummary:
    ...
    @pytest.mark.asyncio
    async def test_get_state_summary_with_state(self, state_manager, mock_file_io, sample_game_state):
        ...
        expected_keys = {
            "session_id", "phase", "ante", "money", "hands_remaining",
            "discards_remaining", "hand_size", "joker_count", "consumable_count",
            "reorder_available", "last_update"
        }
    ...
    @pytest.mark.asyncio
    async def test_get_state_summary_with_update_time(self, state_manager, sample_game_state):
...
class TestStateValidator:
    ...
    def test_validate_state_transition_valid(self, sample_game_state, different_game_state):
        """Test validation of valid state transition."""
        result = StateValidator.validate_state_transition(sample_game_state, different_game_state)
        assert result is True

    def test_validate_session_consistency_valid(self, sample_game_state, different_game_state):
        """Test session consistency validation with same session."""
        result = StateValidator._validate_session_consistency(sample_game_state, different_game_state)
        assert result is True
    ...
    def test_validate_session_consistency_invalid(self, sample_game_state):
        ...
        result = StateValidator._validate_session_consistency(sample_game_state, different_session_state)
        assert result is False

    def test_validate_ante_progression_valid_same(self, sample_game_state):
        """Test ante progression validation with same ante."""
        result = StateValidator._validate_ante_progression(sample_game_state, sample_game_state)
        assert result is True
    ...
    def test_validate_ante_progression_valid_increase(self, sample_game_state):
        ...
        result = StateValidator._validate_ante_progression(sample_game_state, increased_ante_state)
        assert result is True
    ...
    def test_validate_ante_progression_invalid_decrease(self, sample_game_state):
        ...
        result = StateValidator._validate_ante_progression(sample_game_state, decreased_ante_state)
        assert result is False

    def test_validate_phase_transition_always_valid(self, sample_game_state, different_game_state):
        """Test phase transition validation (currently always returns True)."""
        result = StateValidator._validate_phase_transition(sample_game_state, different_game_state)
        assert result is True
...
class TestPrivateUpdateFromFile:
    ...
    @pytest.mark.asyncio
    async def test_update_from_file_success(self, state_manager, mock_file_io, sample_game_state):
    ...
    @pytest.mark.asyncio
    async def test_update_from_file_exception_handling(self, state_manager, mock_file_io):
