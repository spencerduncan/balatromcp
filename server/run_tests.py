...
def main():
    ...
    parser.add_argument(
        "--no-exit", action="store_true", help="Don't exit on test failure"
    )
    ...
    parser.add_argument(
        "--file-io", action="store_true", help="Run only file I/O tests"
    )

    parser.add_argument(
        "--state-manager", action="store_true", help="Run only state manager tests"
    )

    parser.add_argument(
        "--action-handler", action="store_true", help="Run only action handler tests"
    )

    parser.add_argument(
        "--main-server", action="store_true", help="Run only main server tests"
    )

    parser.add_argument(
        "--interfaces", action="store_true", help="Run only interface tests"
    )
